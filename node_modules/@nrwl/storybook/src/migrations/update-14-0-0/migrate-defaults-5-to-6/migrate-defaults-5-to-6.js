...
const util_functions_1 = require("../../../generators/configuration/util-functions");
...
function migrateProjectLevelStorybookInstance(tree, projectName, uiFramework, configFolder) {
    ...
    (0, util_functions_1.createProjectStorybookDir)(tree, projectName, uiFramework, false, false, !!nextBuildTarget, compiler === 'swc');
}
