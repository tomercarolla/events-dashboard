...
function normalizeOptions(options) {
    ...
    return {
        e2eTestRunner: (_a = options.e2eTestRunner) !== null && _a !== void 0 ? _a : "cypress" /* E2eTestRunner.Cypress */,
        ...
        skipPostInstall: (_e = options.skipPostInstall) !== null && _e !== void 0 ? _e : false,
        skipPackageJson: (_f = options.skipPackageJson) !== null && _f !== void 0 ? _f : false,
        style: (_g = options.style) !== null && _g !== void 0 ? _g : 'css',
        unitTestRunner: (_h = options.unitTestRunner) !== null && _h !== void 0 ? _h : "jest" /* UnitTestRunner.Jest */,
    };
}
...
function addE2ETestRunner(host, options) {
    switch (options.e2eTestRunner) {
        case "protractor" /* E2eTestRunner.Protractor */:
            return !options.skipPackageJson
                ...
                : () => { };
        case "cypress" /* E2eTestRunner.Cypress */:
