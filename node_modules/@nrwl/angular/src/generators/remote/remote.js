...
function remote(tree, options) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const installTask = yield (0, application_1.default)(tree, Object.assign(Object.assign({}, options), { mf: true, mfType: 'remote', routing: true, host: options.host, port: (_a = options.port) !== null && _a !== void 0 ? _a : findNextAvailablePort(tree), skipDefaultProject: true }));
