...
function normalizeOptions(host, schema) {
    ...
    const options = Object.assign({ buildable: false, linter: linter_1.Linter.EsLint, name: '', publishable: false, simpleModuleName: false, skipFormat: false, unitTestRunner: "jest" /* UnitTestRunner.Jest */, 
    ...
    const ngCliSchematicLibRoot = newProjectRoot
        ...
        : projectName;
    return Object.assign(Object.assign({}, options), { linter: (_c = options.linter) !== null && _c !== void 0 ? _c : linter_1.Linter.EsLint, unitTestRunner: (_d = options.unitTestRunner) !== null && _d !== void 0 ? _d : "jest" /* UnitTestRunner.Jest */, prefix, name: projectName, projectRoot, entryFile: 'index', moduleName,
        projectDirectory,
        modulePath,
        parsedTags,
        fileName,
